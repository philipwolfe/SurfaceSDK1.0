...
{
    /// <summary>
    /// Custom control representing the piano keyboard
    /// </summary>
    public partial class PianoKeyboard : IDisposable
    {
        ...
        private void OnIsPressedChanged(object sender, EventArgs e)
        {
            ...
            if (isPressed)
            {
                ...
                // event handlers
                if (pianoKey.IsAnyContactOver || pianoKey.IsMouseOver && Mouse.LeftButton == MouseButtonState.Pressed)
                {
