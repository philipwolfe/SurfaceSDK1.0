...
namespace ItemCompare
{
    ...
    /// and firing appropriate events when the visualizations gain tags, lose
    ...
    {
        private readonly Affine2DManipulationProcessor processor;
        ...
        /// <summary>
        /// Fires when the axis should be shown.
        /// </summary>
        public event EventHandler Show;

        /// <summary>
        /// Fires when the axis should be hidden.
        /// </summary>
        public event EventHandler Hide;

        /// <summary>
        /// Fires when the axis moves.
        /// </summary>
        ...
        public bool IsActive
        {
            get
            {
                return (visualization1 != null)
                    && (visualization2 != null)
                    && (visualization1.TrackedContact != null)
                    && (visualization2.TrackedContact != null);
            }
        }
        ...
        public VisualizationAxis(UIElement container)
        {
            ...
            const Affine2DManipulations supportedManipulations =
                Affine2DManipulations.TranslateX
                | Affine2DManipulations.TranslateY
                | Affine2DManipulations.Rotate
                | Affine2DManipulations.Scale;

            processor = new Affine2DManipulationProcessor(supportedManipulations, container);

            processor.Affine2DManipulationStarted += OnManipulationStarted;
            processor.Affine2DManipulationDelta += OnManipulationDelta;
        }
        ...
        /// The scenario can easily occur in the simulator, however, where it is easy to rotate 
        /// a contact in place without moving it at all.
        /// </remarks>
        void OnVisualizationMoved(object sender, TagVisualizerEventArgs e)
        {
            bool isInverted = IsInverted;

            // Fire the Moved event only if VisualizationAxis.IsActive is true (otherwise some
        ...
        private void UpdateVisibility()
        {
            if (!wasPreviouslyActive && IsActive)
            {
                ...
                processor.BeginTrack(visualization1);
                processor.BeginTrack(visualization2);
                if (Show != null)
                {
        ...
        /// <summary>
        /// Here when we begin manipulation.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
