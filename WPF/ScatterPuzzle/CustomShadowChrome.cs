...
{
    /// <summary>
    /// Shadow Chrome for a ScatterViewItem. Unlike the standard SurfaceShadowChrome, 
    /// which can only render a rectangular shadow, this chrome can render a custom shape
    ...
    public class CustomShadowChrome : Decorator
    {
        ...
        /// of the specified SurfaceShadowChrome object.
        /// </summary>
