...
namespace Microsoft.Surface.Samples.ScatterPuzzle
{
    ...
    public partial class Window1
    {
        ...
        void OnPuzzleSelected(object sender, SelectionChangedEventArgs args)
        {
            ...
            // We have to clear the SelectedItem or we won't
            // get a SelectionChanged event when the item is 
            // selected again.
            puzzles.SelectedItem = null;
        ...
        void OnManipulationCompleted(object sender, SSC.ScatterManipulationCompletedEventArgs args)
        {
            // Validate input
        ...
        private void StartJoinIfPossible(ScatterViewItem item)
        {
            ...
            foreach (ScatterViewItem potentialItem in scatter.Items)
            {
                ...
                // See if the pieces are elligible to join
                if (puzzleManager.CanItemsJoin(item, potentialItem))
                {
                    // The pieces are elligible, join them
        ...
        private void RemoveAllPieces () 
        {
            ...
            for (int i = 0; i < scatter.Items.Count; i++)
            {
                ...
                // Can't aminate if center isn't set yet, which would happen if a piece has not yet been manipulated
