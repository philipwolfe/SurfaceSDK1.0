...
namespace Cloth.UI
{
    ...
    internal class ScrollBar : UIElement
    {
                   ...
                   parent)
        {
            ...
            {
                throw new InvalidOperationException("ScrollBarStateMachine orientation is expected to be Horizontal.");
            }
        ...
        {
            scrollBarBackground = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarBackground.png");
            thumbDefaultBackground = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbDefaultBackground.png");
            thumbDefaultLeft = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbDefaultLeft.png");
            thumbDefaultMiddle = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbDefaultMiddletile.png");
            thumbDefaultRight = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbDefaultRight.png");
            thumbExpandedBackground = Texture2D.FromFile(GraphicsDevice,
                                                         @"Content\ScrollBarThumbExpandedBackground.png");
            thumbExpandedLeft = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbExpandedLeft.png");
            thumbExpandedMiddle = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbExpandedMiddletile.png");
            thumbExpandedRight = Texture2D.FromFile(GraphicsDevice, @"Content\ScrollBarThumbExpandedRight.png");
        ...
        public override void Draw(SpriteBatch batch, GameTime gameTime)
        {
            ...
            // Save the state we are going to change.
            Rectangle saveRect = GraphicsDevice.ScissorRectangle;
            bool scissorTestEnable = GraphicsDevice.RenderState.ScissorTestEnable;
            ...
            batch.Begin(SpriteBlendMode, SpriteSortMode,SaveStateMode, ScreenTransform);
            ...
            // Restore RenderState and restart the outer SpriteBatch.
            // This could affect rending of layered element in the SpriteBatch.
            GraphicsDevice.ScissorRectangle = saveRect;
            GraphicsDevice.RenderState.ScissorTestEnable = scissorTestEnable;

            // Restart the SpriteBatch using our parent's batch parameters.
            batch.Begin(Parent.SpriteBlendMode, Parent.SpriteSortMode,
                  Parent.SaveStateMode, Parent.ScreenTransform);
