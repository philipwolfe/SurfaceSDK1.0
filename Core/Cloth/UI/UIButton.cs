//---------------------------------------------------------------------
// <copyright file="UIButton.cs" company="Microsoft">
...
namespace Cloth.UI
{
    ...
    public class UIButton : UIElement
    {
        ...
        /// Pressed event.
        /// </summary>
        /// <returns>True if there is a contact captured to the button.</returns>
        ...
        private void LoadImages()
        {
            ...
            {
                DefaultImage = Texture2D.FromFile(GraphicsDevice, defaultImageFile);
            }
            if (pressedImageFile != null)
            {
                PressedImage = Texture2D.FromFile(GraphicsDevice, pressedImageFile);
            }
