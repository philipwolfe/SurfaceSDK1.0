...
namespace Cloth.UI
{
    ...
    internal class ListBox : UIElement
    {
            ...
            : base(game, contoller, new Vector2(x, y), width, height, parent)
        {
            ...
            {
                throw new InvalidOperationException("ListBox is expected to be inside a UIContainer.");
            }
        }
        ...
        {
            itemDefault = Texture2D.FromFile(Game.GraphicsDevice, @"Content\ItemDefault.png");
            itemHit = Texture2D.FromFile(Game.GraphicsDevice, @"Content\ItemHit.png");
            minBackground = Texture2D.FromFile(Game.GraphicsDevice, @"Content\MinBackground.png");
            maxBackground = Texture2D.FromFile(Game.GraphicsDevice, @"Content\MaxBackground.png");
            ...
            maximizeDefault = Texture2D.FromFile(GraphicsDevice, @"Content\MaximizeDefault.png");
            maximizeHit = Texture2D.FromFile(GraphicsDevice, @"Content\MaximizeHit.png");
            minimizeDefault = Texture2D.FromFile(GraphicsDevice, @"Content\MinimizeDefault.png");
            minimizeHit = Texture2D.FromFile(GraphicsDevice, @"Content\MinimizeHit.png");
        ...
        /// <returns>ListBoxHitTestDetails representing the location of the contact.</returns>
        public override IHitTestDetails HitTestDetails(Contact contact, bool captured)
        {
            ...
            float x = MathHelper.Clamp((contactVector.X - Left) / Width, 0f, 1f);
            float y = MathHelper.Clamp((contactVector.Y - Top) / Height, 0f, 1f);
